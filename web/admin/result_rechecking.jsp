          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Applications  <span>| Result Rechecking</span></h5>
                  ...
                  <table class="table table-bordered datatable" id="example2">
                    ...
                    <c:forEach var="applications" items="${courseRemarkingList}">
                    <tr>     
                        <td>${applications.name}</td>
                        <td>${applications.classid}</td>
                        <td>${applications.id}</td>
                        <td>${applications.phone}</td>
                        <td>${applications.courseId}</td>
                        <td>${applications.courseTitle}</td>
                        <td>${applications.lecturer}</td>
                        <td>${applications.currentResult}</td>
                        <td>${applications.expectedResult}</td>
                        <td>${applications.applicationReason}</td>
                        <td>${applications.supportingEvidence}</td>
                        <td>${applications.applicationDate}</td>
                        <td><c:if test="${applications.evidenceOne != ''}"><a href="D:\GreenwoodUniversity\CourseRechecking\<c:out value='${applications.courseId}'/>\<c:out value='${applications.evidenceOne}'/>">evidence one</a></c:if></td>
                        <td><c:if test="${applications.evidenceTwo != ''}"><a href="D:\GreenwoodUniversity\CourseRechecking\<c:out value='${applications.courseId}'/>\<c:out value='${applications.evidenceTwo}'/>">evidence two</a></c:if></td>
                        <td><c:if test="${applications.evidenceThree != ''}"><a href="D:\GreenwoodUniversity\CourseRechecking\<c:out value='${applications.courseId}'/>\<c:out value='${applications.evidenceThree}'/>">evidence three</a></c:if></td>                   
                    </tr>
                    </c:forEach>
                    </tbody>
                  </table>
