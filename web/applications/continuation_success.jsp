...
<div class="bd-cheatsheet container-fluid bg-white">
    <article class="fw-bold pt-3 pt-xl-5 pb-2 pb-xl-3">
      ...
      <p style="text-align: center" class="display-5">Registration Successful</p>
<p class="lead">${student.engName}, your application to proceed with your study this semester has been successfully submitted.
Please go ahead with the following processes to keep track of your progress towards attaining your degree.
</p>
<p class="lead">Please ensure to check your email: ${student.email}, for further messages and keep an eye on your notifications 
    you might receive here on GU website. Click <a href="${pageContext.request.contextPath}/student/progress_tracker.jsp#fee">here</a> to go back to the graduation tracker.</p>
</div>
 </article>
</div>
