...
<nav class="small" id="toc">
  ...
  <c:forEach var="progress" items="${progressList}">
    ...
    <div style="margin-top: 5em" class="height-100 bg-white">
<div class="row" data-masonry='{"percentPosition": true }'>
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card">
          <img src="${pageContext.request.contextPath}/images/card-1.jpeg" class="bd-placeholder-img" width="100%" height="200" >
        <div class="card-body">
          <h5 class="card-title">Online vs Offline Learning</h5>
          <p class="card-text">Online learning has spiked due to the effect of the global pandemic. What mode of learning do you prefer?</p>
        </div>
      </div>
    </div>
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card p-3">
        <figure class="p-3 mb-0">
          ...
          <figcaption class="blockquote-footer mb-0 text-muted">
            Quote by <cite title="Source Title">Benjamin Franklin</cite>
          </figcaption>
        </figure>
      </div>
    </div>
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card">
          <img src="${pageContext.request.contextPath}/images/card-2.jpg" class="bd-placeholder-img" width="100%" height="200" >

        <div class="card-body">
          <h5 class="card-title">Student Life</h5>
          <p class="card-text">Discover life at GU – enroll in a class outside your major, or join in on the many campus activities that will help you be your best self.</p>
        </div>
      </div>
    </div>
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card text-bg-primary text-center p-3">
        <figure class="mb-0">
          ...
          <figcaption class="blockquote-footer mb-0 text-white">
            Quote by <cite title="Source Title">Elin Nordegren</cite>
          </figcaption>
        </figure>
      </div>
    </div>
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card text-center">
        <div class="card-body">
          ...
          <p class="card-text">Do ensure to attend your lectures today. Attendance is necessary</p>
    ...
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card">
          <img src="${pageContext.request.contextPath}/images/card-3.jpg" class="bd-placeholder-img" width="100%" height="200" >
        <div class="card-body">
          <h5 class="card-title">Campus Life</h5>
          <p class="card-text">Starting a new student life in a different country might be very interesting. Discover more about the campus life at GU.</p>
        </div>
      </div>
    </div>
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card p-3 text-end">
        <figure class="mb-0">
          ...
          <figcaption class="blockquote-footer mb-0 text-muted">
            A famous <cite title="Source Title">Chinese Proverb</cite>
          </figcaption>
        </figure>
      </div>
    </div>
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-text">Today you are proud of Greenwood University. Tomorrow you will be the pride of GU. See what our alumni are doing.</p>
          <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
        </div>
      </div>
    </div>
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card p-3">
        <figure class="p-3 mb-0">
          ...
          <figcaption class="blockquote-footer mb-0 text-muted">
            Quote by <cite title="Source Title">Malcolm Forbes</cite>
          </figcaption>
        </figure>
      </div>
    </div>      
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">Graduating Student Tools. <span class="text-muted">It’ll blow your mind.</span></h2>
        <p class="lead">There are several amazing tools and features for you to make use of. Isn't that mind blowing?.</p>
      </div>
      <div class="col-md-5">
        <img src="${pageContext.request.contextPath}/images/tools.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500">
    ...
    <div id="vision" class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading fw-normal lh-1">Applications are now online. <span class="text-muted">See for yourself.</span></h2>
        <p class="lead">Save yourself the stress and long processes that come with placing Applications. We are now mobile.</p>
      </div>
      <div class="col-md-5 order-md-1">
        <img src="${pageContext.request.contextPath}/images/online.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500">
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">Recommendations. <span class="text-muted">You are the Pride of GU.</span></h2>
        <p class="lead">Greenwood University cares about your future.For that reason we are invested in your future and want the best for you.</p>
      </div>
      <div class="col-md-5">
        <img src="${pageContext.request.contextPath}/images/scholarship.jpeg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500">
