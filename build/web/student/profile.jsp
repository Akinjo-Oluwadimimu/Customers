...
<nav class="small" id="toc">
  ...
  <c:forEach var="progress" items="${progressList}">
    ...
    <p style="text-align: center" class="display-6">Modify your Personal Information</p>
    <div id='containers' class="container">
        <div class="bd-example-snippet bd-code-snippet"><div class="bd-example">
         <form action="modifyInformation" method="post">
             <input type="hidden" name="action" value="modifyInformation">
          <div class="mb-3">
            <label for="studentEngName" class="form-label">English Name</label>
            <input type="text" class="form-control" id="studentEngName" name="studentEngName" value="${student.engName}" required>
          </div>
          <div class="mb-3">
            <label for="studentCnName" class="form-label">Chinese Name</label>
            <input type="text" class="form-control" id="studentCnName" aria-describedby="cnNameHelp" name="studentCnName" value="${student.cnName}" required disabled>
            <div id="cnNameHelp" class="form-text">Send us a mail if your Chinese name is displayed wrongly.</div>
          </div>
          <div class="mb-3">
            <label for="studentPassportNo" class="form-label">passport Number</label>
            <input type="text" class="form-control" id="studentPassportNo" name="studentPassportNo" value="${student.passportNo}" required>
          </div>
          <div class="mb-3">
            <label for="studentId" class="form-label">Student Number</label>
            <input type="text" class="form-control" id="studentId" aria-describedby="cnNameHelp" name="studentId" value="${student.id}" required disabled>
            <div id="studentId" class="form-text">Send us a mail if your Student Number is displayed wrongly.</div>
          </div>
          <div class="mb-3">
            <label for="studentDOB" class="form-label">Date of Birth</label>
            <input type="date" class="form-control" id="studentDOB" name="studentDOB" value="${student.dob}" required>
          </div>
          <div class="mb-3">
            <label for="gender" class="form-label">Gender</label>
            <select class="form-select" id="gender" name="gender">
              <option value="F" <c:if test="${'Female' == gender}"> selected </c:if>>Female</option>
              <option value="M" <c:if test="${'Male' == gender}"> selected </c:if>>Male</option>
            </select>
          </div>
          <div class="mb-3">
            <label for="studentEmail" class="form-label">Email</label>
            <input type="email" class="form-control" id="studentEmail" name="studentEmail" value="${student.email}" required>
          </div>
          <div class="mb-3">
            <label for="studentPhone" class="form-label">Phone</label>
            <input type="tel" class="form-control" id="studentPhone" name="studentPhone" value="${student.phone}" required>
          </div>
          <div class="mb-3">
            <label for="select_page" class="form-label">Country</label>
            <select id="select_page" required class="operator" name="country">
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
            <label for="gender" class="form-label">Gender</label>
            <input type="text" name="gender" class="operator" value="${student.gender}" disabled>
        </div>
