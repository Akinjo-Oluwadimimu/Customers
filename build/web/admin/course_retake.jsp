    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Course Retake</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Applications  <span>| Course Retake</span></h5>

                  <table class="table table-bordered datatable" id="example2">
                    <thead>
                        <tr>    
                        <th>SN</th>
                        <th>Retake Course Name</th>
                        <th>Credit</th>
                        <th>Class Number</th>
                        ...
                        <th>Amount/Course (RMB)</th>
                        <th>Comment</th>
                        <th>Total (RMB)</th>
                        <th>Payment Status</th>
                    </tr>
                    <c:forEach var="retakes" items="${retakeInformationList}">
                    <tr>     
                        <td>${retakes.sn}</td>
                        <td>${retakes.courseTitle}</td>
                        <td>${retakes.unit}</td>
                        <td>${retakes.classid}</td>
                        <td>${retakes.id}</td>
                        <td>${retakes.cnname}</td>
                        <td>${retakes.engname}</td>
                        <td>${retakes.major}</td>
                        <td>${retakes.studentcategory}</td>
                        <td>${retakes.amount}</td>
                        <td>${retakes.comment}</td>
                        <td>${retakes.total}</td>
                        <td>${retakes.paymentstatus}</td>
                    </tr>
                    </c:forEach>
                    </tbody>
                  </table>
