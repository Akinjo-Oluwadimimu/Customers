...
<fmt:formatDate var="date" value="${now}" pattern="dd, MMMM yyyy" />
<!DOCTYPE html>
<html lang="en">
    <head>
...
div#englishProficiency .center, div#graduationEligibility .center{
    text-align: center;
}
div#englishProficiency .right, div#graduationEligibility .right{
    text-align: right;
}
div#englishProficiency span, div#graduationEligibility span{
    text-transform: uppercase;
}
div#englishProficiency p, div#graduationEligibility p{
    text-indent: 10px;
    text-align: justify;
}
div#englishProficiency .stamp-container, div#graduationEligibility .stamp-container {
    position: relative;
    overflow: visible;
  }

div#englishProficiency .stamp, div#graduationEligibility .stamp {
  height: 150px;
  width: 200px;
  position: absolute;
  top: -45px;
...
div#englishProficiency .space, div#graduationEligibility .space{
    height: 50px;
}
div#englishProficiency .center, div#graduationEligibility .center{
        margin-left: auto; 
...
#graduationEligibility, #transcript, #englishProficiency{
  padding: 25px;
  width: 80%;
  margin: 0 auto;
...
<div class="bd-cheatsheet container-fluid bg-white">
    <article class="fw-bold pt-3 pt-xl-5 pb-2 pb-xl-3">
      <p style="text-align: center" class="display-5">Official Documents</p>
      <p class="lead">Hello ${student.engName}, you can request for official documents below.
      These documents may tend to help you in your applications if you would wish to further your study.</p>
      <p class="lead">The official documents that are available are: Stamped Academic Transcript, Graduation Eligibility Letter, and English Proficiency Certificate. 
          Note that you cannot download these documents if you have unsettled debts. Check them out below.</p>
    <hr class="my-4">
    
    <p style="text-align: center" class="display-5" id="stampedTranscript">Stamped Academic Transcript</p>
    <p class="lead">This document is the stamped version of your academic transcript is the University Standard Transcript. It consists of the courses you have taken, your 
    ...
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#StampedTranscript">
            View Stamped Transcript
    </button>
    </div>
    
    <hr class="my-4">

    <p style="text-align: center" class="display-5" id="graduationEligibilityLetter">Graduation Eligibility Letter</p>
    <p class="lead">This official document is a graduation eligibility letter. This letter states that you would be
        qualified for graduating provided you complete all course and assessment requirements. This document may be requested by schools you intend to further your study at. Please click the button below to view this letter.</p>
    <div class="col-12 d-flex justify-content-center">
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#GraduationEligibility">
            Graduation Eligibility Letter
    </button>
    </div>
    
    <hr class="my-4">

    <p style="text-align: center" class="display-5" id="englishProficiencyCertificate">English Proficiency Certificate</p>
    <p class="lead">This official document is an English Proficiency Certificate. This certificate confirms that all of the courses you were taught in Greenwood University were 
        taught in the English. This document may be requested by schools you intend to further your study at. Please click the button below to view this letter.</p>
    <div class="col-12 d-flex justify-content-center">
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#EnglishProficiency">
...
<div class="modal fade" id="StampedTranscript" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-4" id="exampleModalFullscreenLabel">Stamped Academic Transcript</h1>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <button type="button" id="downloadST" class="btn btn-secondary fs-4" <c:if test="${feeStatement.debt != 0}">disabled</c:if>>PDF</button>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <section id="transcript" class="stamp-container">
    <h1 style="text-align: center">GREENWOOD UNIVERSITY</h1>
<table id="myTable" class="center" width="741" cellpadding="0" cellspacing="0" >
<tbody>

<tr>
<th style="border-right: hidden; border-top: hidden; border-left: hidden; border-bottom: hidden" colspan="30" width="741">Academic Transcript</th>
</tr>
...
<div <c:if test="${feeStatement.debt != 0}">hidden</c:if>><img src="${pageContext.request.contextPath}/images/stamp.png" class="stamp"></div>
</tr>
...
<tr>
<td style="border-top: hidden; border-right: hidden; border-bottom: hidden" colspan="3" width="130">&nbsp;Language of instruction</td>
...
<div class="modal fade" id="GraduationEligibility" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-4" id="exampleModalFullscreenLabel">Graduation Eligibility Letter</h1>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <button type="button" id="downloadGE" class="btn btn-secondary fs-4" <c:if test="${feeStatement.debt != 0}">disabled</c:if>>PDF</button>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="center" style="width: 700px" id="graduationEligibility">
            <h1 style="text-align: center">GREENWOOD UNIVERSITY</h1>
        <p class="right">${date}</p>
        <h4 class="center">预毕业证明</h4>
        <p>
            兹 证 明<span> ${student.engName}</span> 小姐, 尼日利亚人(护照号: ${student.passportNo})。现为格林伍德大学国际教育学院本科生，
            专业为${student.cnmajor}。
        </p>
        <p>
            如果该生能够通过所有考试和答辩环节，将在2023年1月30日前获得毕业证书和学位证书。
        </p>
        <p></p>
        <h4 class="center"><b>Confirmation of Eligibility to Graduate</b></h4>
        <p>This is to confirm that  <c:choose> <c:when test="${'Female' == gender}"> Ms. 
    </c:when> <c:otherwise> Mr.</c:otherwise> </c:choose><span> ${student.engName}</span>, ${student.nationality} national, Passport No. ${student.passportNo}, is a 
        final year undergraduate student at Greenwood University (GU).</p>
        <p>Once  <c:choose> <c:when test="${'Female' == gender}"> she </c:when> <c:otherwise> he</c:otherwise> </c:choose> complete all course and assessment requirements, 
        GU will award  <c:choose> <c:when test="${'Female' == gender}"> her </c:when> <c:otherwise> him</c:otherwise> </c:choose> a ${student.degree} in ${student.major} before 30th January 2023.
        </p>
        <div class="space"></div>
        <div style="width: 650px" class="stamp-container">
                <div <c:if test="${feeStatement.debt != 0}">hidden</c:if>><img src="${pageContext.request.contextPath}/images/stamp.png" class="stamp"></div>
        <p class="right">Teaching Administration Office<br>International Education College</p>
        </div>
        <div class="space"></div>
        </div>
      </div>
...
<div class="modal fade" id="EnglishProficiency" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-4" id="exampleModalFullscreenLabel">English Proficiency Certificate</h1>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <button type="button" id="downloadEP" class="btn btn-secondary fs-4" <c:if test="${feeStatement.debt != 0}">disabled</c:if>>PDF</button>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="center" style="width: 700px" id="englishProficiency">
            <h1 class="center">GREENWOOD UNIVERSITY</h1>
        <p class="right">${date}</p>
        <p>To whom it may concern:</p>
        <p></p>
        <h4 class="center">ENGLISH PROFICIENCY LETTER</h4>
        <p>
            This is to certify that all educational activities at Greenwood University-International Education College are 
            conducted in an English Language medium. All lectures, oral and written examinations,  quizzes, seminars, and all other 
            extracurricular activities are conducted in English.
        </p>
        <p>
            In the light of the aforementioned fact, there is no hesitation in recommending <c:choose> <c:when test="${'Female' == gender}">Ms. 
    </c:when> <c:otherwise>Mr.</c:otherwise> </c:choose> <span> ${student.engName}</span>, a ${student.major} graduate, bearer of ${student.nationality}
    passport with passport number ${student.passportNo} to your institution/organization, as <c:choose> <c:when test="${'Female' == gender}"> she </c:when> <c:otherwise> he</c:otherwise> </c:choose> 
    possesses sufficient proficiency in English.
        </p>
        <p>For further inquiries with regards to <c:choose> <c:when test="${'Female' == gender}"> her </c:when> <c:otherwise> him</c:otherwise> </c:choose>
            qualifications, please contact us via email at oluwadimimuakinjo@126.com</p>
       <div class="space"></div>
        <div style="width: 650px" class="stamp-container">
                <div <c:if test="${feeStatement.debt != 0}">hidden</c:if>><img src="${pageContext.request.contextPath}/images/stamp.png" class="stamp"></div>
        <p class="right">Teaching Administration Office<br>International Education College</p>
...
let stbtn = document.getElementById('downloadST');
let gebtn = document.getElementById('downloadGE');
let epbtn = document.getElementById('downloadEP');

let conteudo1 = document.getElementById('transcript');
let conteudo2 = document.getElementById('graduationEligibility');
let conteudo3 = document.getElementById('englishProficiency');
...
gebtn.addEventListener('click', function() {
  doc.addHTML(conteudo2, 0, 10, function() {
    var blob = doc.output("blob");
    window.open(URL.createObjectURL(blob));
  });
})    
epbtn.addEventListener('click', function() {
  doc.addHTML(conteudo3, 0, 10, function() {
    var blob = doc.output("blob");
    window.open(URL.createObjectURL(blob));
  });
})    
