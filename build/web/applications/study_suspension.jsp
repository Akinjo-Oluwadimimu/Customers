...
<input type="hidden" id="status" name="status" value="<%= request.getAttribute("infoUpdateStatus")%>"> 
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="#">Study Suspension</a></li>
...
<div class="bd-cheatsheet container-fluid bg-white">
    <article class="fw-bold pt-3 pt-xl-5 pb-2 pb-xl-3">
      <p style="text-align: center" class="display-5">Study Suspension</p>
      <p class="lead">Hello ${student.engName}, you have decided to suspend your study this semester.
          In order to confirm this decision, you  are required to complete a form 
          stating your reason for this decision with supporting evidence. This could include your doctor's
          report in the case of illness; parent's letter, in the case of family related matters; among others.</p>
      <p class="lead">Please do ensure that all supporting evidence you submit are legitimate
      as illegitimate submissions will attract punishments when discovered. </p>
      
      <form action="suspension" method="post" enctype="multipart/form-data" id="evidenceForm">
      <input type="hidden" name="action" value="suspension">
      <div class="col-md-12 input-group  mb-3">
            <span class="input-group-text">Suspension Reason</span>
            <textarea id="reason" class="form-control" aria-label="With textarea" placeholder="Suspension reason (maximum of 1000 characters)" maxlength="1000" required name="applicationReason"></textarea>
      </div>
      <div class="mb-3">
            <label class="form-label" for="evidence">Supporting Evidence</label>
            <input type="file" id="evidence" name="file" class="form-control" accept="image/jpg, image/jpeg, image/png" aria-describedby="uploadHelp">
            <div id="uploadHelp" class="form-text">Please Upload any Supporting Evidence you have (one image only).</div>
      </div>
      </form>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <p id="status"></p> <div class="d-flex justify-content-center"><img id="output" width="350px"></div>
      </div>
      <div class="modal-footer">
...
const alert = (reason, evidence) => {
  const wrapper = document.createElement('div')
  wrapper.innerHTML = [
    '<p><b>Suspension Reason:</b> <br>'+reason+'</p><p><b>Supporting Evidence:</b></p>'
  ].join('')
...
if (submitbutton) {
  submitbutton.addEventListener('click', () => {
   alert(reason.value, evidence.value);
    OpenBootstrapPopup();
  })
}
