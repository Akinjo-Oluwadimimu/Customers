...
public class ThesisTraining2Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        thesisTraining.setBatch(2);
        String filePath = "D:\\GreenwoodUniversity\\Thesis\\ThesisTraining2\\"+classId+"\\";
        ...
        ProgressTrackerIO.updateTaskDB(studentId, 12, true);
        ProgressTrackerIO.updateProgressDB(studentId, 60);
        ...
        session.setAttribute("progress", 60);
        request.setAttribute("status", "thesis2Done");
