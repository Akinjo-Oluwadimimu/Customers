...
public class FinalReportServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action == null) {
                action = "finalReport";  // default action
            }
        String url = "/student/progress_tracker.jsp";
        if (action.equals("finalReport")) {
        ...
        thesisTraining.setBatch(3);
        String filePath = "D:\\GreenwoodUniversity\\Thesis\\FinalProject\\"+classId+"\\";
        ...
        ProgressTrackerIO.updateTaskDB(studentId, 13, true);
        ProgressTrackerIO.updateTaskDB(studentId, 14, true);
        ProgressTrackerIO.updateProgressDB(studentId, 75);
        ...
        session.setAttribute("progress", 75);
        request.setAttribute("status", "finalProject");
